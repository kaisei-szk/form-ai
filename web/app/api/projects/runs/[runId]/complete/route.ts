...
const ResultsSchema = z.object({
  ...
  retryLoadedCount: z.number().int().min(0).optional(),
  retryResolvedCount: z.number().int().min(0).optional(),
  retryRemainingCount: z.number().int().min(0).optional(),
  holdRetryLoadedCount: z.number().int().min(0).optional(),
  pendingRetryLoadedCount: z.number().int().min(0).optional(),
